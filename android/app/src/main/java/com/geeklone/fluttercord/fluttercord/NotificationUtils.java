...
public class NotificationUtils {
    ...
    private static final String NOTIFICATION_CHANNEL_ID = "com.geeklone.fluttercord";
    private static final String NOTIFICATION_CHANNEL_NAME = "com.geeklone.fluttercord";
