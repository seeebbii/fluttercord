  ...
  void dispose() {
    ...
    if (_isPlaying) {
      ...
      ZegoExpressEngine.instance
          .stopPlayingStream(ZegoConfig.instance.streamID);
    }
      ...
      child: Column(
        children: <Widget>[
          ...
          Row(
            children: <Widget>[
              Text(
                'RoomID: ${ZegoConfig.instance.roomID}',
          ...
          Row(
            children: <Widget>[
              Text(
                'StreamID: ${ZegoConfig.instance.streamID}',
                style: TextStyle(color: Colors.white, fontSize: 9),
              ),
            ],
          ),
          Row(
            children: <Widget>[
              Text(
                'Rendering with: ${true ? 'PlatformView' : 'TextureRenderer'}',
                style: TextStyle(color: Colors.white, fontSize: 9),
              ),
            ],
          ),
          ...
          Row(
            children: <Widget>[
              CupertinoButton(
                ...
                child: Icon(_isUseSpeaker ? Icons.volume_up : Icons.volume_off,
