...
import 'package:fluttercord/topics/video_talk/video_talk_view_object.dart';
...
class _VideoTalkPageState extends State<VideoTalkPage> {
  ...
  Future<void> joinTalkRoom() async {
    ...
    await ZegoExpressEngine.createEngine(ZegoConfig.instance.appID, ZegoConfig.instance.appSign, true, ZegoScenario.Communication, enablePlatformView: true);
