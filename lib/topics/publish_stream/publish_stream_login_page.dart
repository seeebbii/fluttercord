...
import 'package:fluttercord/topics/publish_stream/publish_stream_publishing_page.dart';
...
class PublishStreamLoginPage extends StatefulWidget {
  @override
  _PublishStreamLoginPageState createState() =>
      new _PublishStreamLoginPageState();
}
              ...
              children: <Widget>[
                ...
                Container(
                  ...
                  child: CupertinoButton(
                    child: Text(
                      'Login Room',
                      style: TextStyle(color: Color.fromARGB(255, 110, 30, 30)),
                    ),
                    onPressed: () async {
                      await _createEngine();
                      await _loginRoom();
